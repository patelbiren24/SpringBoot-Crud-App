...
public class PersonService {
	...
	@DeleteMapping("/{id}")
	ResponseEntity<String> deletePerson (@PathVariable (value = "id")long userId){
		Persons personToDelete = this.personRepos.findById(userId).get();
		
		this.personRepos.delete(personToDelete);
